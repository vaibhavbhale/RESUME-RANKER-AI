...
class MultipleFileField(forms.FileField):
    """
    Supports multiple file uploads. Django FileField expects one file,
    but with multiple=True the browser sends a list.
    """
...
class RankUploadForm(forms.Form):
    ...
    def __init__(self, *args, user=None, **kwargs):
        ...
        # Normal recruiters see only their own JDs
